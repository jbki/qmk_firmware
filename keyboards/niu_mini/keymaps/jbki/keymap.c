...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_planck_mit(
        ...
        _______, KC_MS_WH_UP, KC_BTN1,    KC_MS_UP,   KC_BTN2,KC_MS_WH_DOWN, _______, KC_BSLS, KC_EQL, KC_UNDS, KC_MINS, _______,
        _______, _______, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT,  _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______,		   
